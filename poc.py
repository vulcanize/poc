...
def verify_signed_b56t(preimage, base56_pubkey, signed_message):
    ...
    print(address.__str__() + u" signed " + BTCmsg.__str__() + u"? " + unicode(vm))
...
print "Bitcoin public Key: " + str(demo_pubkey.__str__())
print "Message signed with Bitcoin Key by prover: " + signed_message + '\n'

verify_signed_b56t(pimg, str(demo_pubkey.__str__()), signed_message)
