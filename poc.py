...
def verify_signed_b56t(preimage, base56_pubkey, signed_message):
    ...
    b56t = build_b56t(preimage.encode('utf-8'))
...
b56t = build_b56t(pimg.encode('utf-8'))
...
print ("Can broadcast this truncated base56 encoded SHA256 hash of signed message: " + build_b56t(signed_message) + '\n')
